...
export async function lookback(story, rarity) {
  ...
  // כמה מילים משותפות ("לבנון", "תקיפות", "דרום"), ואילו אוסף מקרי נשען
  // רק על שם המוסד או המקום. שתי מילים אינן מספיקות, מפני ששם מוסד הוא
  // לעתים קרובות שתי מילים בעצמו ("בבית החולים איכילוב").
...
const MIN_ARTICLES = 5;      // נפח אמיתי. סף גבוה יותר גורם לסיפור להבהב בין ריצות
